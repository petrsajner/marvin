...
".venv\Scripts\python.exe" -B -m unittest tests.test_workspace tests.test_runtime_support tests.test_prompt_performance tests.test_history_recovery tests.test_webview_runtime tests.test_memory_profiles tests.test_localization tests.test_autocommit tests.test_diff_viewer tests.test_project_checks tests.test_semantic_search tests.test_capabilities
