...
def test_config() -> None:
    ...
    check(bool(installer_version) and APP_VERSION == installer_version and APP_VERSION == "1.7.0",
          "viditelná verze aplikace odpovídá instalátoru 1.7.0")
...
def test_user_manuals() -> None:
    ...
    expected = {
        "Marvin-Manual-EN.pdf": (
            15, ("1.7.0", "Python 3.12", "Installing from the offline backup", "Work Modes",
                 "User-Facing Tool Reference", "Troubleshooting")),
        "Marvin-Manual-CS.pdf": (
            10, ("1.7.0", "Python 3.12", "offline zálohy", "Pracovní režimy",
